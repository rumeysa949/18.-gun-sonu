...
public class C02_dependsOnMethods {
    ...
    DependsOnMethods hangi methodun once calisacagina karar vermez
    ...
    public void nutellaTest(){
        ...
        WebElement sonucYaziElementi = Driver.getDriver().findElement(By.xpath("(//div[@class='sg-col-inner'])"));
    ...
    public void ilkUrunTesti(){
        ...
        Driver.getDriver().findElement(By.xpath("/*[@class='a-section aok-relative s-image-square][1]")).click();
